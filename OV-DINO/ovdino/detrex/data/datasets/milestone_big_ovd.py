...
__all__ = ["load_milestone_big_json", "register_milestone_big_ovd_instances"]


def load_milestone_big_json(
    json_file,
    image_root,
    dataset_name=None,
    ...
    Returns:
        ...
        `Using milestone_big Datasets </tutorials/datasets.html>`_ ) when `dataset_name` is not None.
    ...
    if dataset_name is not None:
        ...
        # The categories in a milestone_big json file may not be sorted.
...
def register_milestone_big_ovd_instances(
    name,
    metadata,
    json_file,
    image_root,
    ...
    DatasetCatalog.register(
        name,
        lambda: load_milestone_big_json(
            json_file,
            image_root,
            name,
...
if __name__ == "__main__":
    ...
    dicts = load_milestone_big_json(sys.argv[1], sys.argv[2], sys.argv[3])
